<!--
Taken a theme from http://w3layouts.com
-->
<!DOCTYPE html>
<html>
<head>
...
// When the window is loaded it will trigger the function passed to addEventListener,
// This appears to be for mobile devices since they show the URL bar until the user scrolls down a little. 1px must be enough. This function is not called immediately, however. After loading the page the function hideURLbar is passed to setTimeout with a timeout of zero milliseconds.
// Using setTimeout with a zero timeout tells the browser to call hideURLbar as soon as it can, but that it should finish whatever else its doing first.
...
<!--header-->
<!--sticky-->
<?php include('function.php'); ?>  <!-- connection to the database file -->

<?php include('top.php'); ?>   <!--header is inserted-->
<!--/sticky-->
	  ...
	  <span></span><img src="images/about-img.png" alt=""><span></span>
	   ...
	   <div class="container">		  
		 ...
		 <div class="col-md-4 about-grids">
             ...
             <div class = "Readmorebutton" align = "right"><a href="aboutus.php"><input type="button" value="Read More" name="sbmt" /></a></div> 
			<!-- Alignment for Readmorebutton class in style.css is not working -->
...
<script type="text/javascript" src="js/jquery.mixitup.min.js"></script>  <!--A high-performance, dependency-free library for animated filtering, sorting, insertion, removal and more-->
<script type="text/javascript">
	$(function () {
		var filterList = {
		init: function () {			/*init() function for initialisation stuff.*/
// MixItUp plugin
// http://mixitup.io
